...
MODEL_VERSION = "3.7.0-TERMINAL-UI"
...
_page_alias = {"Home": "Game", "Bets": "Slate", "Live": "Slate"}
main_view = _page_alias.get(st.session_state.get("cfb_page", "Slate"), st.session_state.get("cfb_page", "Slate"))
...
if run_mode == "Full Slate":
    st.markdown(
        '<div class="mobile-page-head terminal-page-head"><div class="mobile-page-kicker">DAILY TERMINAL</div>'
        '<div class="mobile-page-title">Today&#39;s Slate</div>'
        '<div class="mobile-page-sub">One ranked opportunity set. Official plays only when the model clears its locked production standard.</div></div>',
        unsafe_allow_html=True,
    )
    ...
    if st.button("Run Slate", type="primary", use_container_width=True, key="terminal_run_slate"):
        try:
...
st.divider()
st.caption("CFB Edge • v3.7 Terminal UI • Validated actual market lines • Locked 0.84 spread floor • Automatic official performance tracking.")
